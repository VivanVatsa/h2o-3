def call(final pipelineContext) {
  ...
  def SMOKE_STAGES = [
    [
      stageName: 'Java 14 Smoke - DO ONLY CUSTOM 1/3', target: 'test-junit-smoke-custom', javaVersion: 14, timeoutValue: 200,
      component: pipelineContext.getBuildConfig().COMPONENT_JAVA
    ],
    [
      stageName: 'Java 14 Smoke - DO ONLY CUSTOM 2/3', target: 'test-junit-smoke-custom', javaVersion: 14, timeoutValue: 200,
      component: pipelineContext.getBuildConfig().COMPONENT_JAVA
    ],
    [
      stageName: 'Java 14 Smoke - DO ONLY CUSTOM 3/3', target: 'test-junit-smoke-custom', javaVersion: 14, timeoutValue: 200,
      component: pipelineContext.getBuildConfig().COMPONENT_JAVA
    ]
  ]
